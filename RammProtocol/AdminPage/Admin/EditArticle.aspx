<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPage/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="EditArticle.aspx.cs" Inherits="RammProtocol.EditArticle" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container">
        <div class="left">
            ...
            <div class="buttons">
                <asp:Button ID="btn_saveArticle" runat="server" Text="Save Changes" OnClick="btn_saveArticle_Click" />
            </div>
        </div>
        <div class="right">
            <div class="control-bar">
